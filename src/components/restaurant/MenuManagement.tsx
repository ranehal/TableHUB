          ...
          <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-xl border dark:border-[#2a2a2a]">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 border border-gray-300 dark:border-[#3a3a3a] bg-white dark:bg-[#2a2a2a] text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
